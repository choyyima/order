                        ...
                        <div class="tab-pane active in" id="home">
                            <form action="<?php $_SERVER['PHP_SELF']; ?>" name="form" method="post">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label>No. SMS</label>
                                        <input type="text" name="no_sms" value="<?php echo kodesms(); ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Buyer / Pemesan</label>
                                        <select name="DropDownTimezone" id="DropDownTimezone" class="form-control"></select>
                                    </div>
                                    <div class="form-group">
                                        <label>Flag</label>
                                        <input type="text" name="flag" value="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal_proses" value="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>No. PO</label>
                                        <input type="text" name="no_po" value="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="estimasi" value="" class="form-control">
                                    </div>
                                    <div class="form-group">
